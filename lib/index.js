...
class MenuItem extends React.Component {
  ...
  render() {
    ...
    if (item.type == 'separator') {
      ...
      }, React.createElement("hr", null)); // render a branch item
    } else if (depth) {
      let expandOrAccelerator = hasChildren ? React.createElement(Expander, null) : React.createElement(Accelerator, {
...
const Accelerator = ({
  ...
  return accelerator ? React.createElement("div", {
...
class Buttons extends React.Component {
  ...
  render() {
    let buttons = this.state.fullScreen ? React.createElement(UnFullscreenButton, {
      onClick: this.handleUnFullscreenClick
    }) : React.createElement(React.Fragment, null, React.createElement(MinimizeButton, {
    ...
    }, buttons, React.createElement(CloseButton, {
      key: "close-button",
...
class Electronbar {
  ...
  setMenu(menu) {
    ...
    if (prebuiltMenu) {
      this.electron.remote.Menu.setApplicationMenu(menu); // hijack the menu to create hidden menu item acceleartors
    } else {
