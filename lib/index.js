...
class Electronbar {
  ...
  render() {
    if (this.mountNode && this.browserWindow) {
      ...
      reactDom__default["default"].render( /*#__PURE__*/React__default["default"].createElement(React__default["default"].Fragment, null, /*#__PURE__*/React__default["default"].createElement(TitleBar, {
        menu: this.menu,
        title: this.title,
        icon: this.icon,
        browserWindow: this.browserWindow
      }), contextMenu), this.mountNode);
    }
  }
