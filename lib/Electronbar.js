	...
	(0, _createClass3.default)(MenuItem, [{
		...
		value: function render() {
			...
			if (item.type == 'separator') {
				...
				return _react2.default.createElement(
					'div',
					{ className: _classnames2.default.apply(undefined, ['electronbar-menu-item'].concat(classes)), onMouseLeave: this.handleAntiHover },
				...
				return _react2.default.createElement(
					'div',
					{ className: _classnames2.default.apply(undefined, ['electronbar-top-menu-item'].concat(classes)), onMouseLeave: this.handleAntiHover },
					_react2.default.createElement(
						'div',
